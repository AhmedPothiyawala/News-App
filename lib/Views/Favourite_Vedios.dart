              ...
              if (dataSnapshot.connectionState == ConnectionState.waiting) {
                ...
                if (dataSnapshot.error != null) {
                  ...
                  return apiController.allArticles.length == 0
                      ...
                      : Obx(
                          () => apiController.allArticles.length == 0
                              ? Padding(
                                  padding: EdgeInsets.only(
                                    top: Get.height * 0.4,
                                  ),
                                                          ...
                                                          children: [
                                                            ...
                                                            Padding(
                                                                ...
                                                                child: Obx(
                                                                  () =>
                                                                      IconButton(
                                                                    icon: apiController.allArticles.any((articsssle) =>
                                                                            articsssle.title ==
                                                                            article
                                                                                .title)
                                                                        ? Icon(Icons
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (apiController
                                                                          ...
                                                                          0) {
                                                                        apiController
                                                                            .addTask(apiController.allArticles[index]);
                                                                        Get.snackbar(
                                                                            'Successfully',
                                                                            'Record Added',
                                                                        ...
                                                                        if (apiController.allArticles.any((articsssle) =>
                                                                            articsssle.title ==
                                                                            article.title)) {
                                                                          apiController
                                                                              .remove_favourite(apiController.allArticles[index]);
